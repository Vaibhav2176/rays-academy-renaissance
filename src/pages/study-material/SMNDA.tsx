...
const SMNDA = () => (
  <StudyMaterialPageTemplate
    ...
    importantTopics={['Algebra - Quadratic equations & matrices', 'Trigonometry - Heights & distances', 'Indian History - Freedom movement', 'Current Affairs - Defence updates', "Mechanics - Newton's laws", 'General Science - Basic concepts', 'Geography - Indian geography', 'Analytical Geometry - 2D and 3D']}
