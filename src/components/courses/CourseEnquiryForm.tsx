  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
      <div>
        ...
        <Input id="eq-name" value={name} onChange={e => setName(e.target.value)} placeholder="Enter your name" maxLength={100} />
      </div>
      <div>
        <Label htmlFor="eq-phone">Phone Number</Label>
        <Input id="eq-phone" value={phone} onChange={e => setPhone(e.target.value)} placeholder="Enter 10-digit number" maxLength={10} />
      </div>
      <div>
        <Label htmlFor="eq-course">Course / Class</Label>
